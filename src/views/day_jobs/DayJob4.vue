<template>
	<h1 class="h1">🏅 Day4 - Vue.js 的基礎魔法：v-for</h1>
	<p>
		<a href="https://hackmd.io/v2aX5zCWROiO2xZ4ITJZmw" target="_blank">題目</a>｜
		<a
			href="https://github.com/GitHubPlayerZero/hex-vue3-practise/blob/main/src/views/day_jobs/DayJob4.vue"
			target="_blank"
			>Code</a
		>｜
		<a href="https://codepen.io/codepenplayer/pen/JjQWevX" target="_blank">CodePen</a>
	</p>
	...
	<div id="app" class="container">
		<div class="row">
			<div class="col-md-6 mb-3" v-for="item in fruitData" :key="item.title">
