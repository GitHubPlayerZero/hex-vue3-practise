...
<template>
  <div class="container my-4">
    <h1>表單驗證</h1>
    <p>
      <a href="https://bootstrap5.hexschool.com/docs/5.1/forms/validation/" target="_blank">
        Bootstrap 文件 </a
      >｜
      <a
        href="https://github.com/GitHubPlayerZero/hex-vue3-practise/blob/main/src/views/kit_samples/bootstrap/FormValidation.vue"
        target="_blank"
      >
        code
      </a>
    ...
    <ul class="fs-5 mb-5">
      ...
      <li>礙於 BS 選擇器的設定，錯誤訊息無法放置於群組之下，而必須放置於每個 checkbox 之下。</li>
    </ul>
