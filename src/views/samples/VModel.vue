...
<template>
	...
	<div class="box mb-36">
		...
		<p class="desc">綁定的是 value（option value），若沒有 value 則會綁定到 text（option 顯示內容）。</p>
		...
		<fieldset>
			...
			<p class="desc">注意：不管選取的順序為何，<span class="text-bold">陣列內容都會按下拉選單的 option 順序排列</span></p>
	...
	<div class="box mb-36">
		...
		<fieldset>
			...
			<p class="desc">必須使用陣列來存放資料，若使用單一值則只能存放 true / false，且無法分別勾選。</p>
			...
			<p class="desc">checkbox 必須設定 value，若沒有的話則只會存入 "on"，且操作會變得很怪。</p>
			...
			<p class="desc">正確範例。注意！<span class="text-bold">陣列的內容會按選取的順序排列</span>。</p>
