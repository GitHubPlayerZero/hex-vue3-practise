<template>
	<h1 class="h1">v-model 雙向綁定</h1>
	<p>
		<a
			href="https://github.com/GitHubPlayerZero/hex-vue3-practise/blob/main/src/views/samples/VModel.vue"
			target="_blank"
			>Code</a
		>
	</p>
	...
	<h3>輸入框</h3>
	<div class="box mb-36">
		<input type="text" class="mb-12" v-model="text" />
		<p class="result">結果：{{ text }}</p>
	</div>
		...
		<fieldset class="fieldset">
			...
			<p class="desc">
				...
				<span class="text-bold">
					陣列內容都會按下拉選單的 option 順序排列
				</span>
			</p>

			<label class="d-block mb-20">
				<span class="d-block mb-8">有對應的 value：</span>
			...
			<label class="d-block mb-20">
				<span class="d-block mb-8">沒對應的 value：</span>
				<select multiple style="width: 200px; height: 130px" v-model="cityList">
					<option value="Taipei">台北市</option>
					<option value="Taoyuan">桃園市</option>
			...
			<label class="d-block mb-20">
				<span class="d-block mb-8">沒有 value：</span>
				<select multiple style="width: 200px; height: 130px" v-model="cityList">
					<option>Taipei</option>
			...
			<p class="result mb-8">結果：{{ cityList }}</p>
		</fieldset>
	</div>
	...
	<div class="box mb-36">
		<fieldset class="fieldset mb-24">
			...
			<p class="result mb-24">結果：{{ isChecked }}</p>
		...
		<fieldset class="fieldset">
			...
			<p class="result mb-28">結果：{{ chk4 }}</p>
			...
			<p class="result mb-28">結果：{{ chkList1 }}</p>
	...
	<div class="box">
		...
		<p class="result mb-24">結果：{{ radio1 }}</p>
